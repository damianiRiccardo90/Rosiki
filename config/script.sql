...
(
    ...
    CONSTRAINT PK_Target_Card PRIMARY KEY (ID_CARD) ENABLE
);
...
(
    ...
    CONSTRAINT PK_Player PRIMARY KEY (ID_PLAYER, ID_MATCH) ENABLE,
    CONSTRAINT FK_ID_Match FOREIGN KEY (ID_MATCH) REFERENCES MATCH(ID_MATCH) ON DELETE CASCADE ENABLE,
    CONSTRAINT FK_ID_Target_Card FOREIGN KEY (ID_TARGET_CARD) REFERENCES TARGET_CARD(ID_CARD),
    CONSTRAINT Check_Colour CHECK (COLOUR IN('R', 'N', 'G', 'V', 'B', 'U')) ENABLE
);
...
(
    ...
    CONSTRAINT PK_Turn PRIMARY KEY (ID_TURN, ID_MATCH) ENABLE,
    CONSTRAINT FK_ID_Match FOREIGN KEY (ID_MATCH) REFERENCES MATCH(ID_MATCH) ON DELETE CASCADE ENABLE,
    CONSTRAINT FK_ID_Player FOREIGN KEY (ID_PLAYER, ID_MATCH) REFERENCES PLAYER(ID_PLAYER, ID_MATCH) ON DELETE CASCADE ENABLE
);
...
(
    ...
    CONSTRAINT PK_Territory PRIMARY KEY (ID_TERRITORY) ENABLE
);
...
(
    ...
    CONSTRAINT PK_Reinforcement PRIMARY KEY (ID_REINFORCEMENT, ID_TURN, ID_MATCH) ENABLE,
    CONSTRAINT FK_Turn FOREIGN KEY (ID_TURN, ID_MATCH) REFERENCES TURN(ID_TURN, ID_MATCH) ON DELETE CASCADE ENABLE,
	CONSTRAINT Check_Positioning_Type CHECK (POSITIONING_TYPE IN('0','1','2','3','4','5','6','7','8')) ENABLE,
	CONSTRAINT FK_ID_Territory FOREIGN KEY (ID_TERRITORY) REFERENCES TERRITORY(ID_TERRITORY) ENABLE
);
...
(
    ...
    CONSTRAINT PK_Attack PRIMARY KEY (ID_ATTACK, ID_TURN, ID_MATCH) ENABLE,
    CONSTRAINT FK_Turn FOREIGN KEY (ID_TURN, ID_MATCH) REFERENCES TURN(ID_TURN, ID_MATCH) ON DELETE CASCADE ENABLE,
    CONSTRAINT FK_Attacking_Territory FOREIGN KEY (ID_ATTACKING_TERRITORY) REFERENCES TERRITORY(ID_TERRITORY) ENABLE,
    CONSTRAINT FK_Defending_Territory FOREIGN KEY (ID_DEFENDING_TERRITORY) REFERENCES TERRITORY(ID_TERRITORY) ENABLE,
    CONSTRAINT FK_Defending_Player FOREIGN KEY (ID_DEFENDING_PLAYER, ID_MATCH) REFERENCES PLAYER(ID_PLAYER, ID_MATCH) ON DELETE CASCADE ENABLE,
    CONSTRAINT Check_Positioning_Type CHECK((POSITIONING_TYPE = 1) OR ( POSITIONING_TYPE = 2)),
    CONSTRAINT Check_Result CHECK((RESULT = 0) OR (RESULT = 1))
);
...
(
    ...
    CONSTRAINT PK_Dice_Roll PRIMARY KEY (ID_ATTACK, N_ROLL, ID_TURN, ID_MATCH) ENABLE,
    CONSTRAINT FK_Attack FOREIGN KEY (ID_ATTACK, ID_TURN, ID_MATCH) REFERENCES ATTACK(ID_ATTACK, ID_TURN, ID_MATCH) ON DELETE CASCADE ENABLE,
    CONSTRAINT Check_Dice CHECK((DIE1_ATT BETWEEN 1 AND 6) AND (DIE2_ATT BETWEEN 1 AND 6) 
...
(
    ...
    CONSTRAINT PK_Strategic_Positioning PRIMARY KEY (ID_TURN, ID_MATCH) ENABLE,
    CONSTRAINT FK_Turn FOREIGN KEY (ID_TURN, ID_MATCH) REFERENCES TURN(ID_TURN, ID_MATCH) ON DELETE CASCADE ENABLE,
    CONSTRAINT FK_Starting_Territory FOREIGN KEY (ID_STARTING_TERRITORY) REFERENCES TERRITORY(ID_TERRITORY) ENABLE,
    CONSTRAINT FK_Landing_Territory FOREIGN KEY (ID_LANDING_TERRITORY) REFERENCES TERRITORY(ID_TERRITORY) ENABLE
);
...
(
    ...
    CONSTRAINT FK_ID_Territory FOREIGN KEY (ID_TERRITORY) REFERENCES TERRITORY(ID_TERRITORY) ENABLE,
    CONSTRAINT FK_ID_Neighbour FOREIGN KEY (ID_NEIGHBOUR) REFERENCES TERRITORY(ID_TERRITORY) ENABLE
);
...
(
    ...
    CONSTRAINT PK_Territory_Card PRIMARY KEY (ID_CARD) ENABLE,
    CONSTRAINT Check_Type CHECK(TYPE IN('J', 'O', 'F', 'C', 'A')) ENABLE -- The fuck is 'O'?
);
...
(
    ...
    CONSTRAINT PK_Ass_Card_Territory_Player PRIMARY KEY (ID_CARD, ID_PLAYER, ID_MATCH) ENABLE,
    CONSTRAINT FK_Player FOREIGN KEY (ID_PLAYER,ID_MATCH) REFERENCES PLAYER(ID_PLAYER,ID_MATCH) ON DELETE CASCADE ENABLE,
    CONSTRAINT FK_Territory FOREIGN KEY (ID_CARD) REFERENCES TERRITORY_CARD(ID_CARD) ON DELETE CASCADE ENABLE
);
...
(
    ...
    CONSTRAINT PK_Occupied_Territory PRIMARY KEY (ID_TERRITORY, OCCUPYING_PLAYER, ID_MATCH) ENABLE,
    CONSTRAINT FK_Territory FOREIGN KEY(ID_TERRITORY) REFERENCES TERRITORY(ID_TERRITORY) ENABLE,
    CONSTRAINT FK_Occupying_Player FOREIGN KEY (OCCUPYING_PLAYER, ID_MATCH) REFERENCES PLAYER(ID_PLAYER, ID_MATCH) ON DELETE CASCADE ENABLE
);
